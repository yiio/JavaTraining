        ...
        int pointD = 0;
        {
            ...
            for (int i = 0; i < pointArys.length; i++) {
                if (pointArys[i][0] == "山田" || pointArys[i][0] == "田中") {
                    pointA1 += Integer.parseInt(pointArys[i][1]);
                } else if (pointArys[i][0] == "鈴木") {
                    pointB1 += Integer.parseInt(pointArys[i][1]);
            ...
            // 点数を出す
            System.out.println("Aチームの合計得点は、" + pointA1 + "点です。");
            System.out.println("Bチームの合計得点は、" + pointB1 + "点です。");
